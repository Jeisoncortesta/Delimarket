...
CREATE TABLE `detalle_transaccion` (
  ...
  KEY `fk id_cliente_idx` (`ID_CLIENTE`),
  CONSTRAINT `fk id_cliente` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `tabla_cliente` (`ID_CLIENTE`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2024-05-15 23:45:53
